<footer class="text-white bg-slate-900 py-8">
      <div class="gap-y-6 max-w-6xl mx-auto px-5 flex flex-col md:flex-row flex-wrap justify-between mb-8">
        ...
        <div class="w-full md:w-1/3">
          ...
          <div>
            <ul class="space-y-2">
              <li><a href="https://thuanbui.me" class="text-gray-400 hover:text-white">My Tech Blog</a></li>
              <li><a href="https://yeuchaybo.com" class="text-gray-400 hover:text-white">My Running Blog</a></li>
            </ul>
          </div>
          </div>
        </div>
         ...
         <!-- Copyright -->
         <div class="pt-8 border-t border-gray-700 text-sm text-gray-400 text-center">
          <p>&copy; 2025 - Proudly made by Laravel</p>
      </div>
</footer>
